...
const char resources_config_DIR_scan_page_outer_html_data[17221] = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\r\n" \
...
"</html>\r\n" \
"";
const resource_hnd_t resources_config_DIR_scan_page_outer_html = { RESOURCE_IN_MEMORY, 17220, { .mem = { resources_config_DIR_scan_page_outer_html_data }}};
