...
wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    /* BLE scan settings  */
    {
        ...
        WICED_BT_CFG_DEFAULT_CONN_MIN_INTERVAL,                     /**< High duty cycle minimum connection event interval */
        WICED_BT_CFG_DEFAULT_CONN_MAX_INTERVAL,                     /**< High duty cycle maximum connection event interval */
        ...
        WICED_BT_CFG_DEFAULT_CONN_MIN_INTERVAL,                     /**< Low duty cycle minimum connection event interval */
        WICED_BT_CFG_DEFAULT_CONN_MAX_INTERVAL,                     /**< Low duty cycle maximum connection event interval */
